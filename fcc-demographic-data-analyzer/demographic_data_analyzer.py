...
def calculate_demo_data(print_data=True):
    # Read data from file
    ...
    # Adding .strip() handles any hidden spaces in the column text
    ...
    country_rich_percentages = (country_rich_counts / country_counts * 100)
